...
### 1.5. Modelo con todas las variables
...
Como se puede observar al tener el modelo con todas las variables se obteiene que ninguna variable es significativa, por lo tanto se procede a realizar el modelo con las variables numericas y variables que se consideran significativas.
...
### 1.7 Elaboración de modelos distintos

#### 1.7.1 Primer Modelo cambiando las varaibles predictorias 
...
Podemos obsservar que las curvas de aprendizaje se mantienen relativamente constantes y casi convergiendo entre 32.5% hasta 80% de los datos. Pero mientas más se acerca a 100% de los datos, la curva de test se aleja de la curva de train. Esto indica que el modelo tiene overfitting. Esto nos que utilizar todas las variables que mostraron significancia no es una buena opción.


#### 1.7.2 Segundo Modelo cambiando las varaibles predictorias 
...
### 1.8 Análisis de la eficiencia de los modelos
